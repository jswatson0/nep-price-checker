$(document).ready(function(){
  ...
  // populate frame and matte on these styles
  setStyle = function(){
    var style = $("#style").val();
  ...
  // set the pricebook variable when client is changed
  setClient = function(){
    var client = $("#client").val();
    if(client === "Gallery Direct"){
      $priceBook = "price6_i";
    }else{
      if(client === "Photos.com"){
        $priceBook = "price4_i";
      }
    }
  }
